...
const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl text-center">
      ...
      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024-2025 <a href="#" className="hover:underline">Devapex™</a>. All Rights Reserved.</span>
      <p className='text-xs text-gray-500 mt-1 sm:text-center dark:text-gray-400'>Special Thanks to Nilesh Singh & Lavish</p>
  </div>
</footer>
  )
}
