...
<section className="py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full flex flex-col justify-center items-center lg:w-1/2">
                    <h2
                        className="font-manrope text-5xl text-blue-600 font-bold leading-[4rem] mb-7 text-center lg:text-left">
                        Core Team  </h2>
                   
                    <button className="cursor-pointer py-3 px-8 w-60 bg-blue-600 text-white text-base font-semibold transition-all duration-500 block text-center rounded-full hover:bg-indigo-700 mx-auto lg:mx-0">Join
                        Join Us</button>
                </div>
                <div className="w-full lg:w-1/2 lg:mt-0 md:mt-40 mt-16 max-lg:max-w-2xl">
                    <div className="grid grid-cols-1 min-[450px]:grid-cols-2 md:grid-cols-3 gap-8">
                        <img src="https://imgtr.ee/images/2024/09/14/a74f7938a92cfaa23b9e0b3b6122139c.jpeg" alt="Team tailwind section"
                            className="w-44 h-56 rounded-2xl object-cover md:mt-20 mx-auto min-[450px]:mr-0" />
                        <img src="https://imgtr.ee/images/2024/09/14/334cdea41deefffed8933c36923de2cb.jpeg" alt="Team tailwind section"
                            className="w-44 h-56 rounded-2xl object-cover mx-auto min-[450px]:ml-0 md:mx-auto" />
                        <img src="https://imgtr.ee/images/2024/09/14/259e581a95db24b8eae2bbeddb27ddd7.jpeg" alt="Team tailwind section"
                            className="w-44 h-56 rounded-2xl object-cover md:mt-20 mx-auto min-[450px]:mr-0 md:ml-0" />
                        <img src="https://imgtr.ee/images/2024/09/14/af6a77cd7d7f60827b677a03c2cf3790.jpeg" alt="Team tailwind section"
                            className="w-44 h-56 rounded-2xl object-cover mx-auto min-[450px]:ml-0 md:mr-0 md:ml-auto" />
                        <img src="https://imgtr.ee/images/2024/09/14/74c6b3c1ee66ff3ae075f0db5a2b9066.jpeg" alt="Team tailwind section"
                            className="w-44 h-56 rounded-2xl object-cover md:-mt-20 mx-auto min-[450px]:mr-0 md:mx-auto" />
                        <img src="https://imgtr.ee/images/2024/09/14/d277fda23ab694c492fc9b645b5ddd11.jpeg" alt="Team tailwind section"
    ...
    <section className="py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center flex-col lg:flex-row md:mt-20">
            <div className="w-full lg:w-1/2 lg:mt-0 md:mt-40 mr-10 mt-16 max-lg:max-w-2xl">
                    <div className="grid grid-cols-1 min-[450px]:grid-cols-2 md:grid-cols-3 gap-8">
