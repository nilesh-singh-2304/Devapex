            ...
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
              <div className="max-w-2xl text-center mx-auto">
                ...
                <div className="mt-5 max-w-2xl">
                  <img
                    src="https://imgtr.ee/images/2024/09/13/903f3b4b5daca3433e5fdd1a2445b87a.png"
                    alt=""
                  />
                </div>
                ...
                <div className="mt-5 max-w-3xl">
                  <p className="text-lg text-gray-600 dark:text-neutral-300">
                    Welcome to DevApex, where code meets community. Level up
                    your skills, collaborate with fellow developers, and unlock
          ...
          <div className="max-w-7xl max-lg:max-w-3xl max-sm:max-w-sm mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
              {allCourse?.map((item: any) => (
                <div
                  key={item._id}
                  className="bg-gray-500 cursor-pointer rounded overflow-hidden group"
                >
                  <div className="relative overflow-hidden">
                    <img
                      src={item.imgurl}
...
export async function getServerSideProps() {
  ...
  const course = res.data.data.filter(
